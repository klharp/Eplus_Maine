...
var link = "static/js/map_OH_TX_MN_CA.geojson";
...
d3.json(link).then(function(data) {
  ...
  L.geoJson(data, {
    ...
    onEachFeature: function (feature, layer) {
      ...
      layer.bindPopup("<h2>" + feature.properties.NAME  + "</h2>" + "<p>" + "Go to data and visualizations &rArr; " + feature.properties.Link + "</p>");
    }
